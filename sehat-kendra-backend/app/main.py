...
@app.post("/care-ai")
def care_ai(request: CareAIRequest):

    question = request.question.lower().strip()

    # General wellness
    if "wellness" in question:
        answer = (
            "For general wellness, focus on regular sleep, balanced meals, "
            "adequate hydration, daily physical activity, stress management, "
    ...
    # Medical condition
        ...
        answer = (
            "A medical condition is a health problem that may have specific "
            "symptoms, causes, and treatments. I can explain health conditions "
            "in simple terms, but a doctor should make an individual diagnosis "
            "and treatment decision."
        )

    # Medicine
    elif "medicine" in question or "medication" in question:
        answer = (
            "Medicines should be taken exactly as prescribed. I can explain "
            "what a medicine is generally used for and common precautions, "
            "but your doctor or pharmacist should confirm whether it is "
            "appropriate for you."
        )

    # Doctor consultation
    elif "consult" in question or "doctor" in question:
        answer = (
            "You should consult a doctor for new, persistent, worsening, "
            "or unexplained symptoms. If symptoms are severe or you think "
            "you may have an emergency, seek immediate medical care."
        )

    # Fever
    elif "fever" in question:
        answer = (
            "Fever can occur with infections and other conditions. Rest, "
            "drink enough fluids, and monitor your temperature. If the fever "
            "is severe, persistent, or accompanied by concerning symptoms, "
    ...
    # Headache
        ...
        answer = (
            ...
            "lack of sleep, or illness. Rest and hydration may help. If the "
            "headache is sudden, severe, or unusual for you, seek medical attention."
        )

    # Diabetes
    elif "diabetes" in question:
        answer = (
            "Diabetes involves higher-than-normal blood glucose levels. "
            "Management commonly includes monitoring, healthy eating, "
            "physical activity, and prescribed treatment. Your doctor can "
    ...
    # Blood pressure
        ...
        answer = (
            "Blood pressure can be affected by stress, diet, activity, "
            "and other health conditions. Regular monitoring and following "
            "your doctor's treatment plan are important."
        )
    ...
    # Emergency
        ...
        or "can't breathe" in question
        or "cannot breathe" in question
        or "chest pain" in question
    ):
        answer = (
            "If you are experiencing a medical emergency such as severe "
            "difficulty breathing, severe chest pain, loss of consciousness, "
            "or feeling that you may be in immediate danger, seek emergency "
            "medical care immediately rather than relying on Care AI."
        )

    # General fallback
    else:
        answer = (
            "I can help with general health education, medicines, symptoms, "
            "wellness, and when to seek medical care. Please describe your "
            "health question in a little more detail."
        )
